...
namespace MPSC.PlenoSoft.MultiTenancy.Core.Testes
{
	...
	public class TestandoUsuario
	{
		...
		{
			var usuario = co.Adicionar(new Usuario() { Id = 1, Owner = null, Nome = "Bruno Fernandes (Admin)", EMail = "bruno@dominio.com.br", Celular = "21 9 8765-4321" });
			usuario.DefinirSenhaInicial("Abc@123!", "Abc@123!");

			var sistema = co.Adicionar(new Sistema() { Id = 1, Nome = "MPSC.PlenoSoft.MultiTenancy.Core", Sigla = "MT.Core" });
